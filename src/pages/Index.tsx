...
export default function Index() {
  ...
  return (
    <div className="min-h-screen bg-black text-white selection:bg-yellow-400 selection:text-black">
      ...
      <section className="border-y border-zinc-900 py-8 bg-zinc-950/60">
      ...
      {/* ========== DELIVERY DIRECTORY ========== */}
      <section className="border-t border-zinc-900 bg-zinc-950 py-10">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap items-center justify-center gap-2 max-w-4xl mx-auto">
            {deliveryCities.map((city) => (
              <span
                key={city}
                className="px-3 py-1 rounded-lg bg-zinc-900 border border-zinc-800 text-xs font-bold text-zinc-300"
              >
                {city}
              </span>
            ))}
      ...
      <footer className="bg-black border-t border-zinc-900 py-14 text-white">
        <div className="container mx-auto px-4">
          ...
          <div className="border-t border-zinc-900 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-zinc-500 font-medium">
